...
export default function ICProcessorClient() {
  ...
  const processImage = (
    ...
    // Calculate scaled dimensions (max width 1500px)
  ...
  return (
    <div className="min-h-screen bg-black text-white py-8">
      ...
      <div className="max-w-7xl mx-auto px-4">
        <h1 className="text-3xl font-bold text-center mb-8">IC Image Processor</h1>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Front IC Section */}
          <div>
            <div className="bg-gray-900 rounded-lg shadow p-6 mb-8">
              <h2 className="text-xl font-semibold mb-4">Front IC</h2>
              <div className="border-2 border-dashed border-gray-700 rounded-lg p-6 text-center">
                ...
                >
                  {frontImage ? frontImage.name : 'Upload Front IC Image'}
                </label>
              </div>
            </div>
            ...
            {frontImage && (
              <>
                ...
                <div className="bg-gray-900 rounded-lg shadow p-6 mb-8">
                  ...
                  <div className="relative">
                    <canvas
                      ...
                      className="w-full rounded-lg touch-none bg-gray-900"
                ...
                <div className="bg-gray-900 rounded-lg shadow p-6 mb-8">
                  ...
                  {processedFrontUrl && (
                    <div className="relative">
                      <img src={processedFrontUrl} alt="Processed Front IC" className="w-full rounded-lg" />
                      <button
          ...
          <div>
            <div className="bg-gray-900 rounded-lg shadow p-6 mb-8">
              <h2 className="text-xl font-semibold mb-4">Back IC</h2>
              <div className="border-2 border-dashed border-gray-700 rounded-lg p-6 text-center">
                <input
                  type="file"
                  accept="image/*,.heic,.heif"
                ...
                <label
                  ...
                  className="cursor-pointer block p-4 text-gray-400 hover:text-gray-200"
                >
                  {backImage ? backImage.name : 'Upload Back IC Image'}
                </label>
              </div>
            </div>
            ...
            {backImage && (
              <>
                ...
                <div className="bg-gray-900 rounded-lg shadow p-6 mb-8">
                  ...
                  {processedBackUrl && (
                    <div className="relative">
                      <img src={processedBackUrl} alt="Processed Back IC" className="w-full rounded-lg" />
                      <button
